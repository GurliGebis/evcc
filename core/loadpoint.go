...
// SetBatteryCostBasis records the battery's real per-kWh price/CO2 basis for cost-attribution
// purposes (#33251 step 3). See Site.batteryCostBasis.
func (lp *Loadpoint) SetBatteryCostBasis(price, co2 *float64) {
	lp.energyMetrics.SetBatteryCostBasis(price, co2)
}
